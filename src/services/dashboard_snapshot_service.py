...
class DashboardSnapshotService:
    ...
    def _build_snapshot(self) -> dict:
        ...
        # Use MONTHLY records where available, fill gaps from daily aggregation
        ...
        # Fill gaps: aggregate daily records by month, only for months without MONTHLY data
        daily_by_month: dict[str, dict] = {}
        for r in trend_records:
            month_key = r.period[:7]
            if month_key in monthly_by_period:
                continue  # skip — already have MONTHLY data for this month
        ...
        monthly_by_period.update(daily_by_month)
